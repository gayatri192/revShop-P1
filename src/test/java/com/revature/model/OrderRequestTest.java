...
class OrderRequestTest {
    ...
    void testGetFirstName() {
        assertEquals("abhijeet", orderRequest.getFirstName());
    }
    ...
    void testGetLastName() {
        assertEquals("Doe", orderRequest.getLastName());
    }
    ...
    @Test
    void testGetEmail() {
        assertEquals("abhijeet.pawar@example.com", orderRequest.getEmail());
    }
    ...
    void testToString() {
        ...
        assertEquals(expectedString, orderRequest.toString());
    }
}
